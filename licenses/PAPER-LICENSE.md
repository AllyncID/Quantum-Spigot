...
[GNU General Public License version 3](PAPER-GPL-3.0.md); as it inherits it from Spigot,
...
under the original [GPL](PAPER-GPL-3.0.md) license.

In the interest of promoting a better Minecraft platform for everyone, contributors
may choose to release their code under the more permissive [MIT License](PAPER-MIT.md).

The authors listed below have chosen to release their code under that more permissive
[MIT License](PAPER-MIT.md). Any contributor who wants their name added below
